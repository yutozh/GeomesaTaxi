...
public class GeomesaStart {
    private final Map<String, String> params;
    private final TutorialData data;
    private final boolean cleanup;

    public GeomesaStart(String[] args, DataAccessFactory.Param[] parameters, TutorialData data) throws ParseException {
    ...
    public static void main(String[] args){
        try {
            ...
            new GeomesaStart(args,  new HBaseDataStoreFactory().getParametersInfo(), new GeomesaData()).run();
